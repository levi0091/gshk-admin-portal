...
> | | |
> |---|---|
> | `module` | `post_incorporation` · `body_corporate` · `natural_person` · `documents` · `cr_filing` — **the sidebar's own names**, because that is the vocabulary the operator already has |
